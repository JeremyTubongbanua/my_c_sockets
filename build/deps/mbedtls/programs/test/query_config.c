...
int query_config(const char *config)
{
    ...
    if( strcmp( "MBEDTLS_P256M_EXAMPLE_DRIVER_ENABLED", config ) == 0 )
    {
        MACRO_EXPANSION_TO_STR( MBEDTLS_P256M_EXAMPLE_DRIVER_ENABLED );
        return( 0 );
    }
...
#if defined(MBEDTLS_P256M_EXAMPLE_DRIVER_ENABLED)
    OUTPUT_MACRO_NAME_VALUE(MBEDTLS_P256M_EXAMPLE_DRIVER_ENABLED);
#endif /* MBEDTLS_P256M_EXAMPLE_DRIVER_ENABLED */
